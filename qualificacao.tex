...
\section{Introdução}
    ...
    \begin{frame}
        ...
        \begin{figure}
            \begin{tikzpicture}
                \draw[fill=red!60!black] 
                    (-4,0) rectangle (-0.1,1.7)
                    node[midway, right,scale=3, color=white] {$1.$};

                \draw[fill=gray!60, opacity=0.8]
                    (0,0) rectangle (8,1.7)
                    node[midway, scale=3, color=white]
                    {Introdução};
            \end{tikzpicture}
        \end{figure}
    \end{frame}
...
\section{Resultados - Pt1}
    ...
    \begin{frame}
        ...
        \begin{figure}
            \begin{tikzpicture}
                \draw[fill=red!60!black] 
                    (-4,0) rectangle (-0.1,1.7)
                    node[midway, right,scale=3, color=white] {$2.$};
    ...
    \begin{frame}
        ...
        \begin{itemize}
            \item
                O Processo Pontual que servirá de base para nosso estudo
                pode ser entendido como\\[0.5cm]
                \begin{center}
                    A evolução temporal de chamadas telefônicas na reta
                    real sendo que apenas $C$ chamadas podem ocorrer
                    simultâneamente no mesmo ponto\\[0.5cm]
                \end{center} 

            \item Exemplo: fixado um tempo $t \in \R$ e $C = 3$ temos
                \begin{figure}
                    \centering
                    \begin{tikzpicture}
                        \draw[->, line width=2pt] (0,0) -- (7,0) node[right] {$\R$};

                        \draw[red,    |-|, line width=1pt] (1.0, 0.2) -- (2.0,0.2);
                        \draw[green,  |-|, line width=1pt] (1.5, 0.4) -- (4.0,0.4);
                        \draw[blue,   |-|, line width=1pt] (6.0, 0.2) -- (6.5,0.2);
                        \draw[yellow, |-|, line width=1pt] (0.0, 0.6) -- (1.7,0.6);

                        \draw[-, dotted, very thick] (1.5, -1) 
                            node[below, draw] {este ponto não pode haver mais ligação}
                            -- (1.5, 0.8);
                    \end{tikzpicture}
                \end{figure}
        \end{itemize}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            \item
                O mesmo Exemplo, agora considerando sua dinâmica no tempo

                \begin{figure}
                    \centering
                    \begin{tikzpicture}
                        \draw[->, line width=2pt] (8,-1) -- (8,4) node[above] {$t$};
                        \draw (3.5,3.8) node[above, scale=1.5] {$\vdots$};
                        \draw (3.5,-1.0) node[below, scale=1.5] {$\vdots$};
                        \begin{scope}
                            \draw[->, line width=2pt] (0,0) -- (7,0) node[right] {$\R$};
                        ...
                        \begin{scope}[shift={(0,1.5)}]
                            ...
                            \draw[blue,   |-|, line width=1pt] (6.0, 0.2) -- (6.5,0.2);
                            \draw[yellow, |-|, line width=1pt] (0.0, 0.6) -- (1.7,0.6);
                            \draw[cyan,   |-|, line width=1pt] (4.5, 0.4) -- (6.2,0.4);
                            \draw[brown,  |-|, line width=1pt] (3.0, 0.6) -- (5.0,0.6);
                        \end{scope}
        ...
        \begin{itemize}
            ...
            \item
                ...
                \begin{figure}
                    \centering
                    \begin{tikzpicture}
                        \draw (0,0) node[scale=2, draw, dashed] {Simulação Perfeita};
                    \end{tikzpicture}
                \end{figure}
                ...
                \begin{enumerate}
                    ...
                    \item
                        ...
                        \begin{tikzpicture}
                            ...
                            \draw[-|] (2,0) -- (8,0) node[above] {$b$};
                            \draw[->] (6,0) -- (9,0);

                            \fill[blue] (2.5,0) circle (0.1cm);
                            \fill[blue] (5,0) circle (0.1cm);
                            \fill[blue] (7,0) circle (0.1cm);
                        \end{tikzpicture}
                \end{enumerate}
    ...
    \begin{frame}
        ...
        \begin{enumerate}
            ...
            \item
                E gerar uma sequência de pontos ancestrais a $x_i$
                % figura {{{3
                \begin{tikzpicture}[scale=0.8]
                    \draw[-|] (0,0) -- (2,0) node[above] {$a$};
                    \draw[-|] (2,0) -- (8,0) node[above] {$b$};
                    ...
                    \fill[blue] (2.5,0) circle (0.1cm);
                    \draw[fill=blue,opacity=0.3,dashed] (2.5,0) rectangle (3,-1);

                    \fill[blue] (2.8,-0.8) circle (0.1cm);
                    \draw[fill=blue,opacity=0.3,dashed] (2.8,-0.8) rectangle (3.1,-1.4);

                    \fill[blue] (3,-1.25) circle (0.1cm);
                    \draw[fill=blue,opacity=0.3,dashed] (3,-1.25) rectangle (4,-4);

                    \fill[blue] (5,0) circle (0.1cm);
                    \draw[fill=blue,opacity=0.3,dashed] (5,0) rectangle (6,-3);

                    \fill[blue] (4.5,-2) circle (0.1cm);
                    \draw[fill=blue,opacity=0.3,dashed] (4.5,-2) rectangle (5.8,-5);

                    \fill[blue] (5.4,-1) circle (0.1cm);
                    \draw[fill=blue,opacity=0.3,dashed] (5.4,-1) rectangle (6.8,-7);

                    \fill[blue] (5.2,-2.5) circle (0.1cm);
                    \draw[fill=blue,opacity=0.3,dashed] (5.2,-2.5) rectangle (5.7,-4);

                    \fill[blue] (7,0) circle (0.1cm);
                    \draw[fill=blue,opacity=0.3,dashed] (7,0) rectangle (7.5,-2);

                    \draw[->, line width=2pt] (10,-7.2) -- (10,0.2) node[above] {$t$};
                \end{tikzpicture}
                % END figure 3}}}
    ...
    \begin{frame}
        ...
        \begin{enumerate}
            ...
            \item
                Com os pontos ancestrais uma  filtração é
                realizada baseada no máximo de ligações simultâneas $C$

            \item
                Por exemplo, sendo $C=3$
                % figura {{{3
                \begin{figure}
                    \centering  
                ...
                \begin{tikzpicture}[scale=0.6]
                    ...
                    \def\excluir{(4.4,+0.1) rectangle (6.9,-7.1);}
                    \draw[red, dotted, line width=2pt] \excluir;
                    \begin{scope}
                        \clip \excluir
                        \draw[line width=2pt, red, opacity=0.6]
                            (4.4,0.1) -- (6.9, -7.1);
                        \draw[line width=2pt, red, opacity=0.6]
                            (4.4,-7.1) -- (6.9, 0.1);
                    \end{scope}
    ...
    \begin{frame}
        ...
        \begin{enumerate}
            ...
            \item
                Após a filtração, o Processo Pontual será:

                \begin{enumerate}[(i)]
                    \item
                        Os  pontos $x_1, x_2, \ldots, x_N$ restantes
                        da filtração;

                    \item
                        E os retângulos ancestrais, formando o \emph{clã
                        de ancestrais}
                \end{enumerate}
                % figura {{{3
                \begin{figure}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            \item
                Dado o Processo Pontual resultante da Simulação
                Perfeita, denotado por $\zeta$

            \item
                Vamos Estudar o comportamento da taxa do \emph{número
                de persistência de Betti de dimensão $0$} de $\zeta$ na
                janela
                \begin{equation*}
                    \Lambda = \left[ -\frac{L}{2}, \frac{L}{2} \right] \cap \zeta,
                \end{equation*}
                com $L \in \R_{>0}$, fazendo $L \to \infty$


                \begin{tikzpicture}[scale=0.8]
                    \draw[->] (-5,0) -- (7,0) node[below, right] {$\R$};

                    \draw[|-|, ultra thick, red]
                           (-3,0) node[below] {$-\frac{L}{2}$}
                        -- (3,0) node[below] {$\frac{L}{2}$};

                        \fill[blue] (-4.0,0.0) circle (0.1cm);
                        \fill[blue] (-4.5,0.0) circle (0.1cm);
                        \fill[blue] (-3.5,0.0) circle (0.1cm);
                        \fill[blue] (+3.5,0.0) circle (0.1cm);
                        \fill[blue] (+5.0,0.0) circle (0.1cm);
                        \fill[blue] (+6.3,0.0) circle (0.1cm);
                        \fill[blue] (+0.0,0.0) circle (0.1cm);
                        \fill[blue] (+0.9,0.0) circle (0.1cm);
                        \fill[blue] (+1.4,0.0) circle (0.1cm);
                        \fill[blue] (+2.3,0.0) circle (0.1cm);

                        \draw[->, ultra thick] (3,-1) -- (4,-1) node[right] {$\infty$};
                        \draw[->, ultra thick] (-3,-1) -- (-4,-1) node[left] {$\infty$};
                \end{tikzpicture}
        \end{itemize}
    \end{frame}
    %END frame 2}}}
    ...
    \begin{frame}
        ...
        \begin{tikzpicture}[scale=1]
            ...
            \begin{scope}[shift={(4,0)}, yscale=2]
                \draw[ultra thick, ->] (0,0) ..controls (2,-0.5) and (2,-1.5) .. (0,-2);

            \end{scope}

            \draw (7,-5) node[scale=2] {$\frac{\beta_0^{a,b}}{L}$};
        \end{tikzpicture}
    \end{frame}
    %END frame 2}}}
    ...
    \begin{frame}
        ...
        \begin{figure}
            \begin{tikzpicture}
                \draw[fill=red!60!black] 
                    (-4,0) rectangle (-0.1,1.7)
                    node[midway, right,scale=3, color=white] {$3.$};
